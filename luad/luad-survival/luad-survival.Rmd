...
# survival: Hmisc::cut2, splits days survived into quantiles
heatmap_metadata$days_survived[heatmap_metadata$days_survived == 0] = NA
heatmap_metadata$survival = with(heatmap_metadata, cut2(days_survived, g = 9))
...
annot_colors = list(stage = setNames(c(brewer.pal(4, "Set1"), "grey"), levels(heatmap_metadata$stage)),
                    ...
                    survival = setNames(c(brewer.pal(9, "Reds"), "grey"), levels(heatmap_metadata$survival)),
