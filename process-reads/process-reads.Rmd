...
- v3: Hepatocellular carcinoma (LIHC), colorectal (COAD and READ), pancreatic (PAAD), testicular germ cell (TGCT), lower grade glioma (LGG)
...
```{r download-files}
metadatas <- list(luad = luad_metadata, brca = brca_metadata, prad = prad_metadata, lihc = lihc_metadata, coad = coad_metadata, paad = paad_metadata, tgct = tgct_metadata, lgg = lgg_metadata)
currentwd <- getwd()
