...
tp_before_pca_plot <- plotPCA(counts[, prad_metadata$cell_type == "TP"])
tp_after_pca_plot <- plotPCA(counts[, prad_metadata$cell_type == "TP"])
nt_before_pca_plot <- plotPCA(counts[, prad_metadata$cell_type == "NT"])
nt_after_pca_plot <- plotPCA(counts[, prad_metadata$cell_type == "NT"])
```
